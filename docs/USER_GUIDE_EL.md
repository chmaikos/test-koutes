...
Έκδοση οδηγού: 18 Αυγούστου 2026
...
7. Όλα τα επιλέξιμα κιβώτια επιλέγονται αρχικά.
8. Αποεπιλέξτε όσα θα παραμείνουν για μεταγενέστερη μερική επιστροφή.
9. Ελέγξτε τη διαδρομή `Source → Target` και πατήστε **Submit request**.
...
αιτήματα πρέπει να διευθετηθούν, καθώς και πόσα από τα αιτήματα χρησιμοποιούν
την αποθήκη ως source και πόσα ως target.
