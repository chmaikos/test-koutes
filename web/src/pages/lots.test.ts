...
function mergeCandidateFixture(
  ...
  return {
    ...
    pallet_collisions: [],
    pallet_collision_count: 0,
    pallet_collisions_truncated: false,
    pallet_actions: [],
    pallet_action_count: 0,
    pallet_actions_truncated: false,
    file_reference_collisions: [],
    file_reference_collision_count: 0,
    file_reference_collisions_truncated: false,
    active_file_reference_collision_count: 0,
    archived_file_reference_collision_count: 0,
...
const purgePreview: LotPurgePreview = {
  ...
  active_pallet_ids: [],
  active_pallet_ids_truncated: false,
  archived_pallet_count: 1,
  archived_pallet_ids: [70],
  archived_pallet_ids_truncated: false,
...
describe("safe lot purge", () => {
  ...
  it("formats the preview removal scope and actionable blockers", () => {
    expect(lotPurgeRemovalItems(purgePreview)).toEqual([
      ...
      "1 pallet and its pallet history",
...
const forcePreview: LotForcePurgePreview = {
  ...
  archived_box_ids_truncated: false,
  active_pallet_ids: [70],
  active_pallet_count: 1,
  active_pallet_ids_truncated: false,
  archived_pallet_ids: [71],
  archived_pallet_count: 1,
  archived_pallet_ids_truncated: false,
