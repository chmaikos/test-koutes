...
Υπάρχουν δύο διαφορετικές διορθώσεις, μόνο για Admin:
...
Και οι δύο ενέργειες απαιτούν υποχρεωτικό λόγο και την τρέχουσα έκδοση. Αν το
lot άλλαξε ενδιάμεσα, εμφανίζεται σύγκρουση και πρέπει να φορτωθεί η νεότερη
έκδοση. Μετονομασία σε ήδη υπάρχουσα καθολική ταυτότητα ή επανατοποθέτηση που
θα δημιουργούσε διπλό `(lot, box number)` απορρίπτεται. Το audit κρατά παλιό/νέο
