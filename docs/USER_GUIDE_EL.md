...
Έκδοση οδηγού: 11 Αυγούστου 2026
...
- Αν το νέο όνομα αντιστοιχεί σε υπάρχον lot, η εφαρμογή **δεν συγχωνεύει
  ...
  **Merge** με την ίδια υποχρεωτική αιτιολογία. Η συγχώνευση επιτρέπεται μόνο
  όταν τα δύο lots δεν έχουν κανένα κοινό φυσικό `box number`. Ο έλεγχος
  περιλαμβάνει και τα αρχειοθετημένα κιβώτια, επειδή μπορούν να επανέλθουν.
  Αν υπάρχουν επικαλύψεις, το Merge απενεργοποιείται και εμφανίζονται οι αριθμοί
  που πρέπει πρώτα να διορθωθούν.
