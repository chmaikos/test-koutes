...
Έκδοση οδηγού: 17 Σεπτεμβρίου 2026
...
Κάθε φυσικό File έχει υποχρεωτικό reference και προαιρετικά περιγραφή και
barcode. Είναι παρακολουθούμενη εγγραφή αποθέματος με θέση μέσα στο Κιβώτιο,
...
- αναζητήσετε με αριθμό Κιβωτίου, Lot, Παλέτα, compatibility Contents ή
  reference/description/barcode ενεργού φυσικού File,
...
4. Συμπληρώστε:
   ...
   - προαιρετικά **File description** και **File barcode** για κάθε File.
...
Κιβώτιο. Το ίδιο barcode μπορεί να χρησιμοποιείται σε περισσότερα Files.
...
6. Αντιστοιχίστε τις στήλες του αρχείου με:
   ...
   - προαιρετικά **File description** και **File barcode**,
...
- Το ίδιο File reference δεν μπορεί να δείχνει σε δύο διαφορετικά Κιβώτια του
  ίδιου Lot. Ίδιο reference με διαφορετική περιγραφή/barcode είναι σύγκρουση.
- Η περιγραφή File είναι προαιρετική έως 10.000 χαρακτήρες και το barcode
  προαιρετικό έως 255. Το παλαιό Contents παραμένει προαιρετικό έως 2.000
  χαρακτήρες και δεν αντικαθιστά το File reference.
...
- αναζητήσετε reference, περιγραφή, barcode, αριθμό Κιβωτίου, Lot, Παλέτα ή
  αποθήκη,
...
10.000 χαρακτήρες και το barcode προαιρετικό έως 255· το barcode δεν αποτελεί
μοναδικό κλειδί.

Η λεπτομέρεια δείχνει τη διαδρομή **Lot → Pallet/Unassigned → Box → File**,
reference, περιγραφή, barcode, θέση μέσα στο Κιβώτιο, inherited αποθήκη και
status, έκδοση και χρόνους δημιουργίας/ενημέρωσης. Το **File audit timeline**
...
File σε ενεργό Κιβώτιο ενεργού Lot και να αλλάζουν reference, περιγραφή ή
barcode. Κάθε μεταβολή χρησιμοποιεί την τρέχουσα έκδοση· αν μεσολάβησε άλλη
αλλαγή, ανανεώστε τη σελίδα και ελέγξτε ξανά.
...
Αν το Κιβώτιο δεσμεύεται από ενεργό αίτημα επιστροφής, η αλλαγή μόνο
description/barcode επιτρέπεται, επειδή το request snapshot δεν ξαναγράφεται.
...
- χειροκίνητα, προσθέτοντας γραμμές lot/προαιρετική pallet/box number και ένα
  ή περισσότερα φυσικά Files με υποχρεωτικό reference και προαιρετικά
  description/barcode,
...
2. αντιστοιχίστε υποχρεωτικά lot, box number και File reference, προαιρετικά
   File description/barcode, και για pallet επιλέξτε στήλη ή ρητά **Leave new
   boxes Unassigned**,
...
- γνωστό reference στο ίδιο Κιβώτιο ενημερώνει μόνο όταν αλλάζουν
...
Περιλαμβάνουν File ID/reference, description, barcode, θέση, ολόκληρη την
